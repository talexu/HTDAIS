...
public class TestVectorProcessor {

	Logger logger = LoggerFactory.getLogger(TestVectorProcessor.class);
	...
	public void setUp() throws Exception {
		...
		vectorProcessor = new VectorProcessor(analysisProcessor);
	...
	public void testExecute() {
		...
		logger.debug("Distance: "
				+ vectorProcessor.getVectorCalculator().distance(
						quantizedNews.getVector(), quantizedNews2.getVector()));
	}
