...
public class TextExtract {
	...
	private static Pattern imgSrcPattern = Pattern.compile(
	...
	public String getTitle(String source) {
		return matchString(source, titlePattern);
	}
	 ...
	 * @return
	 */
	public String getImgSrc(String source) {
		return matchString(source, imgSrcPattern);
	}

	private String matchString(String source, Pattern pattern) {
		if (source != null) {
	...
	public String getImgAndText(String source) {
